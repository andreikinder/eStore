...
<form class="checkout_coupon woocommerce-form-coupon row" method="post" style="display:none">
	...
	<p class="col-md-12 my-2"><?php esc_html_e( 'If you have a coupon code, please apply it below.', 'woocommerce' ); ?></p>

	<p class="form-row form-row-first col-md-8">
	...
	<p class="form-row form-row-last col-md-4">
